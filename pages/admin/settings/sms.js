...
const SMSSettings = () => {
    ...
    return (
        <>
            <PageTitle title={!!i18n && i18n?.t("Sms Settings")} />
            ...
            <Form layout="vertical" form={form} onFinish={async values => {
                ...
                <Row>
                    ...
                    <Col md={6}>
                        <FormInput name={['sms', 'twilio_sender_number']} label="Twilio Sender Number"
                    ...
                    <Col md={6}>
                        <FormSelect name={['sms', 'status']} label="Status"
                                    initialValue={false}
...
SMSSettings.layout = AdminLayout
