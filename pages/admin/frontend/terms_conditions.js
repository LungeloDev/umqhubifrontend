...
const TermsConditions = () => {
    ...
    const [TermsConditions, getTermsConditions] = useFetch(fetchPage, {pages: 'terms_conditions'}, false);
    ...
    const onFinish = async (values) => {
        const payload = {
            title: "Terms & Conditions", page: "terms_conditions", content: {
                terms_conditions: {
                    type: "object", name: 'terms_conditions', value: values, lang: language
                }
            }
        };
    ...
    return (<section>
        <div className='card_container'>
            <PageTitle title="Terms & Conditions" breadcrumbs={[{label: 'Dashboard', href: '/admin'}, {label: 'Settings'}]}/>
