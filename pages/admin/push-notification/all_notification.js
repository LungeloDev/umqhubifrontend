...
const UserNotification = () => {
    ...
    const [allNotifications, getAllNotifications] = useFetch(fetchNotification, {status: 'all'});
    ...
    const columns = [
        ...
        {
            dataField: 'body', text: 'Body', formatter: (cell) => cell?.substring(0, 39)
        },
        {
            dataField: 'status',
            text: 'Status',
    ...
    return (
        <div>
            <PageTitle title=" All Notification" />
